...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 3, vars: 0, consts: [[1, "main"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _components_list_header_list_header_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/list-header/list-header.component */ "./src/app/components/list-header/list-header.component.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_10__["AppComponent"],
        ...
        _components_list_header_list_header_component__WEBPACK_IMPORTED_MODULE_13__["ListHeaderComponent"],
        _components_item_item_component__WEBPACK_IMPORTED_MODULE_14__["ItemComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_9__["AppRoutingModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"],
        _angular_material_input__WEBPACK_IMPORTED_MODULE_5__["MatInputModule"],
...
/* harmony import */ var src_app_services_get_list_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/get-list.service */ "./src/app/services/get-list.service.ts");
...
const _c0 = ["inputTag"];
function FilterComponent_option_6_Template(rf, ctx) { if (rf & 1) {
...
function FilterComponent_option_10_Template(rf, ctx) { if (rf & 1) {
...
class FilterComponent {
    constructor(getListService) {
        this.getListService = getListService;
        this.firstCounter = 0;
        this.secondCounter = 0;
    }
    ngOnInit() {
        this.getListService.valueSeries.subscribe((data) => {
    ...
    ngAfterViewInit() {
        Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["fromEvent"])(this.inputElem.nativeElement, 'keyup')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["debounceTime"])(700), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((event) => event.target.value), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(value => value.length > 2 || value.length === 0), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["distinctUntilChanged"])())
            .subscribe(value => {
    ...
    filterName(value) {
        ...
        if (!value) {
            ...
            this.changedResponse = this.response.filter((el) => el.name.toLowerCase().indexOf(value.toLowerCase()) >= 0);
        }
        this.getListService.transferData(this.changedResponse);
    }
    filterListGenres(value) {
    ...
    filterGenre(value, response) {
        return value === "All genres" ?
            response : response.filter((el) => el.genre.indexOf(value) >= 0);
    }
    filterDate(value, response) {
        return value === "All dates" ?
            response : response.filter((el) => el.premiere.indexOf(value) >= 0);
    }
}
FilterComponent.ɵfac = function FilterComponent_Factory(t) { return new (t || FilterComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_get_list_service__WEBPACK_IMPORTED_MODULE_3__["GetListService"])); };
FilterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: FilterComponent, selectors: [["app-filter"]], viewQuery: function FilterComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 12, vars: 3, consts: [[1, "form-name", "filter"], ["type", "text", "placeholder", "Name", "name", "name", 1, "form-field", 3, "ngModel", "ngModelChange"], ["inputTag", ""], [1, "fas", "fa-search"], [1, "box-select", "filter"], ["id", "genre", 1, "select", 3, "change"], ["class", "option", 4, "ngFor", "ngForOf"], [1, "select-arrow"], ["id", "date", 1, "select", 3, "change"], [4, "ngFor", "ngForOf"], [1, "option"]], template: function FilterComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "input", 1, 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function FilterComponent_Template_input_ngModelChange_1_listener($event) { return ctx.searchName = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](3, "i", 3);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](4, "div", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](5, "select", 5);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function FilterComponent_Template_select_change_5_listener($event) { return ctx.filter($event.target.value, $event.target.id); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function FilterComponent_Template_select_change_9_listener($event) { return ctx.filter($event.target.value, $event.target.id); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FilterComponent, [{
    ...
    }], function () { return [{ type: src_app_services_get_list_service__WEBPACK_IMPORTED_MODULE_3__["GetListService"] }]; }, { inputElem: [{
...
function ItemComponent_span_4_Template(rf, ctx) { if (rf & 1) {
...
function ItemComponent_span_8_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const network_r15 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
...
ItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ItemComponent, selectors: [["app-item"]], inputs: { dataSeries: "dataSeries" }, decls: 11, vars: 5, consts: [[1, "box-name-genres", "column"], [1, "series-name"], [1, "box-genres"], ["class", "list-values genre", 3, "ngClass", 4, "ngFor", "ngForOf"], [1, "series-season", "column"], [1, "series-networks", "column"], ["class", "list-values", 4, "ngFor", "ngForOf"], [1, "series-premiere", "column"], [1, "list-values", "genre", 3, "ngClass"], [1, "list-values"]], template: function ItemComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var src_app_models_list_series_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/models/list-series.model */ "./src/app/models/list-series.model.ts");
/* harmony import */ var _list_header_config__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./list-header.config */ "./src/app/components/list-header/list-header.config.ts");
/* harmony import */ var src_app_services_get_list_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/get-list.service */ "./src/app/services/get-list.service.ts");
...
function ListHeaderComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListHeaderComponent_div_0_Template_i_click_5_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10); const column_r8 = ctx.$implicit; const ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r9.sortData(column_r8.type, column_r8.name, "up"); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](6, "i", 4);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListHeaderComponent_div_0_Template_i_click_6_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10); const column_r8 = ctx.$implicit; const ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r11.sortData(column_r8.type, column_r8.name, "down"); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
class ListHeaderComponent {
    ...
    sortData(type, name, directionSort) {
        let changedResponse;
    ...
    sortDataByString(columnName, directionSort, arr) {
        return arr.sort((a, b) => {
            if (directionSort === "up") {
    ...
    sortDataByNumber(columnName, directionSort, arr) {
        return arr.sort((a, b) => {
            if (directionSort === "up") {
    ...
    sortDataByDate(columnName, directionSort, arr) {
        return arr.sort((a, b) => {
            if (directionSort === "up") {
                return this.changeDateFormat(a[columnName]) >
                    this.changeDateFormat(b[columnName]) ? 1 : -1;
            }
            if (directionSort === "down") {
                return this.changeDateFormat(a[columnName]) >
                    this.changeDateFormat(b[columnName]) ? -1 : 1;
...
ListHeaderComponent.ɵfac = function ListHeaderComponent_Factory(t) { return new (t || ListHeaderComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_get_list_service__WEBPACK_IMPORTED_MODULE_3__["GetListService"])); };
ListHeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ListHeaderComponent, selectors: [["app-list-header"]], decls: 1, vars: 1, consts: [["class", "column-header", 3, "ngClass", 4, "ngFor", "ngForOf"], [1, "column-header", 3, "ngClass"], [1, "sort-arrow"], [1, "fas", "fa-angle-up", 3, "click"], [1, "fas", "fa-angle-down", 3, "click"]], template: function ListHeaderComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ListHeaderComponent, [{
    ...
    }], function () { return [{ type: src_app_services_get_list_service__WEBPACK_IMPORTED_MODULE_3__["GetListService"] }]; }, null); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ListColumns", function() { return ListColumns; });
/* harmony import */ var src_app_models_list_series_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/app/models/list-series.model */ "./src/app/models/list-series.model.ts");

const ListColumns = [
    {
        name: src_app_models_list_series_model__WEBPACK_IMPORTED_MODULE_0__["HeaderColumns"].name,
        class: `col-${src_app_models_list_series_model__WEBPACK_IMPORTED_MODULE_0__["HeaderColumns"].name}`,
    ...
    },
    {
        ...
        class: `col-${src_app_models_list_series_model__WEBPACK_IMPORTED_MODULE_0__["HeaderColumns"].season}`,
    ...
    },
    {
        ...
        class: `col-${src_app_models_list_series_model__WEBPACK_IMPORTED_MODULE_0__["HeaderColumns"].network}`,
        type: src_app_models_list_series_model__WEBPACK_IMPORTED_MODULE_0__["ColumnsType"].string,
    },
    {
        name: src_app_models_list_series_model__WEBPACK_IMPORTED_MODULE_0__["HeaderColumns"].premiere,
        class: `col-${src_app_models_list_series_model__WEBPACK_IMPORTED_MODULE_0__["HeaderColumns"].premiere}`,
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var src_app_services_get_list_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/services/get-list.service */ "./src/app/services/get-list.service.ts");
/* harmony import */ var _list_header_list_header_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../list-header/list-header.component */ "./src/app/components/list-header/list-header.component.ts");
...
ListComponent.ɵfac = function ListComponent_Factory(t) { return new (t || ListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_get_list_service__WEBPACK_IMPORTED_MODULE_1__["GetListService"])); };
ListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ListComponent, selectors: [["app-list"]], decls: 4, vars: 8, consts: [[3, "dataSeries", 4, "ngFor", "ngForOf"], ["pageSize", "10", "showFirstLastButtons", "true", 3, "length", "pageSizeOptions", "page"], [3, "dataSeries"]], template: function ListComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("page", function ListComponent_Template_mat_paginator_page_3_listener($event) { return ctx.getPaginatorData($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
    ...
    } }, directives: [_list_header_list_header_component__WEBPACK_IMPORTED_MODULE_2__["ListHeaderComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["NgForOf"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_4__["MatPaginator"], _item_item_component__WEBPACK_IMPORTED_MODULE_5__["ItemComponent"]], pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["SlicePipe"]], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvbGlzdC9saXN0LmNvbXBvbmVudC5zY3NzIn0= */"] });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ListComponent, [{
    ...
    }], function () { return [{ type: src_app_services_get_list_service__WEBPACK_IMPORTED_MODULE_1__["GetListService"] }]; }, null); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HeaderColumns", function() { return HeaderColumns; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ColumnsType", function() { return ColumnsType; });
var HeaderColumns;
...
class GetListService {
    ...
    getListSeries() {
        this.http.get(this.listSeriesUrl).subscribe((data) => {
...
GetListService.ɵfac = function GetListService_Factory(t) { return new (t || GetListService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"])); };
GetListService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: GetListService, factory: GetListService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](GetListService, [{
...
module.exports = __webpack_require__(/*! D:\angular\series\series-client-app\src\main.ts */"./src/main.ts");
